...
public class MessageConstant {
    public static final String RESOURCE_EMPTY = "Resource is empty";
    ...
    public static final String DESCRIPTION_LENGTH = "Description must be at least 10 characters";

    public static final String TUTORIAL_CREATED = "Tutorial has been created";
